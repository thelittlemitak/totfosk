import AlbumWrapper from "./level-2-components/AlbumWrapper";
import Header from "./Header";
import "./Level1style.css";

function MainInfluencesPage() {
  const albumInfo = [
    // {
    //   artist: "Aphex Twin",
    //   album: "Drukqs",
...
export default MainInfluencesPage;

{
  /* <AlbumWrapper
        imgIDTunnel={1}
        albumInfoTunnel={albumInfo[0]}
      ></AlbumWrapper>
      <AlbumWrapper
        imgIDTunnel={2}
        albumInfoTunnel={albumInfo[1]}
      ></AlbumWrapper>
      <AlbumWrapper
        imgIDTunnel={3}
        albumInfoTunnel={albumInfo[2]}
      ></AlbumWrapper>
      <AlbumWrapper
        imgIDTunnel={4}
        albumInfoTunnel={albumInfo[3]}
      ></AlbumWrapper> */
}
